...
- Додаткова перевірка атрибутів у назві (колір, тип пам'яті, об'єм, вага, діагональ, розміри на кшталт `120x190`), щоб відсікати хибні дублікати
- Універсальні евристики для різних категорій (електроніка, матраци, зоотовари тощо) без ручного вибору профілю
